...
The dataset was entered by hand and thus has inconsistencies and omissions that will require cleaning.  Some data cleaning has already been performed. TO DO: Assign data type (numeric, factor, date), handle missing information, group and summarise, etc.


#### Explore

Histogram of variables, etc
...
- `r fa(name = "gamepad")` Entertainment: Video Games reviews [`r fa(name = "cloud-arrow-up")`](https://posit.cloud/content/4990394)
